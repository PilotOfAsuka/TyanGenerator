...
async def in_main_state(message):
    ...
    await is_press_button(message=message, menu_name="main_menu", button_index=4, answer_text=get_about_text(users_data.get_user_language(message=message)), reply_markup=menuConstructor.get_menu_with_lang(message=message, menu_name="main_menu"))
